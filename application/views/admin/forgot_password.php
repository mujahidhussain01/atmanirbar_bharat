				...
				<div class="right-content">
					...
					<div class="otp-content" style="display:none;">
						<form id="otpform" method="post" class="margin-bottom-0">
							...
							<div class="form-group m-b-15">
								<input type="password" class="form-control form-control-lg" placeholder="Enter Password" required name='Password' minlength = "8">
							</div>
							<div class="form-group m-b-15">
								<input type="password" class="form-control form-control-lg" placeholder="Confirm Password" required name='confPassword' minlength = "8">
							</div>
							<div class="login-buttons">
								<button type="submit" class="btn btn-primary btn-block btn-lg">Save & Login</button>
							</div>
...
$.ajax({
url:"<?php echo base_url()?>admin/Forgot_password/sendotp",
method:"POST",
data:$(this).serialize(),
                success:function(data)
                {
...
event.preventDefault();
$.ajax({
url:"<?php echo base_url()?>admin/Forgot_password/checkotp",
method:"POST",
data:$(this).serialize(),
                success:function(data)
                {
