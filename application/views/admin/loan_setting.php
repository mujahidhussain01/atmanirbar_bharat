...
<div id="content" class="content">
	...
	<ol class="breadcrumb float-xl-right">
		...
		<li class="breadcrumb-item active"><a href="javascript:;">Loan Setting</a></li>
	...
	<div id="add_loan_setting" class="panel panel-inverse">
		...
		<div class="panel-heading">
			...
			<h4 class="panel-title">Add New Loan Settings</h4>
	...
	<div id="edit_loan_setting" class="panel panel-inverse" data-sortable-id="ui-general-6" style="display: none">
		...
		<div class="panel-heading ui-sortable-handle">
			...
			<h4 class="panel-title">Edit Loan Settings</h4>
	...
	<div class="panel panel-inverse">
		...
		<div class="panel-heading">
			...
			<h4 class="panel-title">View all Loan Settings</h4>
