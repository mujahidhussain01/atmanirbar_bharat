    ...
    <div class="content-wrapper-before" style="position: relative;">
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12">
                <h5 class="content-header-title text-center mt-1 text-white">Payment Marked As Received</h5>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div class="panel-body">
                            ...
                            <a href="<?=base_url( 'manager/loans/loan_payments/'.$loan_apply_id )?>"><button type="submit" class="btn btn-lg btn-primary">Ok</button></a>
                            </div>
                        </div>
                    </div>
                </div>
