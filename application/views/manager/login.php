...
<html lang="en">
	<head>
		...
		<title>Atma Nirbhar Bharat Manager | Login Page</title>
			...
			<div class="login login-v2 animated fadeIn">
				...
				<div class="right-content">
                    ...
                    <div class="brand">
                        ...
                        </span> <b>Manager</b> Login

                        <!--<small>responsive bootstrap 4 manager template</small>-->
...
<!--					</div>-->
					...
					<div class="login-content">
						...
						<form action="<?php echo base_url()?>manager/login/logincheck" method="post" class="margin-bottom-0">
							...
							<!--<p class="text-center text-grey-darker mb-0">
								...
								&copy; Color manager All Right Reserved 2020
