...
class Manage_payments extends CI_Controller
{
    ...
    public function mark_payment_received()
    {
        ...
        {
            echo json_encode( [ 'success' => false, 'msg' =>  'Amount Received Cannot Be Greater Than Emi Amount, If User Is Giving More Amount Than Emi Amount, Please Receive Amount In Next Payment Or Use Foreclose Loan Feature' ] );
            return;
        }
